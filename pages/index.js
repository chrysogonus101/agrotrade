...
export default function Index  () {
  ...
  <main className="bg-home w-full h-screen lg:h-[] flex flex-col justify-end ">
    {/* bottom content */}
    <div className="flex flex-col gap-6 h-[40%] bg-gradient-to-b from-green-600/90 to-green-900 p-3 pb-12">
